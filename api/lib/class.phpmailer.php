...
class PHPMailer {
 ...
 /**
  ...
  const CRLF = "";     // SMTP RFC specified EOL
 ...
 */
  ...
  */
  public function EncodeQP($string, $line_max = 76, $space_conv = false) {
    ...
    $fp = fopen('php://temp/', 'r+');
    $string = preg_replace('/?/', $this->LE, $string); //Normalise line breaks
  ...
  */
  ...
  public function DKIM_Add($headers_line, $subject, $body) {
    ...
    return "X-PHPMAILER-DKIM: code.google.com/a/apache-extras.org/p/phpmailer/".$dkimhdrs.$signed."";
  }
